...
\begin{exercise}[subtitle= Dé à 20 faces]
	...
	\begin{tasks}
		...
		\task Combien de lancers de 3 dés faudrait-t-il réaliser pour avoir 9 chances sur 10 d'obtenir un évènement $\Ac$ (\ie que tous les élèves aient la moyenne$\dots$) ? 
	\end{tasks}
\end{exercise}
